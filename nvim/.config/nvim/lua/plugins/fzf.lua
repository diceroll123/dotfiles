...
return {
  ...
  },
  {
    ...
    keys = {
      ...
      --   desc = "Resume Fzf",
      -- }, -- Find file by live grep, better for large projects
      -- {
      --   "<leader>fl",
      --   function()
      --     local root_dir = require("utils.root").git()
      ...
      --   end,
      --   desc = "Find Files at project directory",
      -- }, -- Find files by live grep in the current directory or LSP root or git root
      -- {
      --   "<leader>/",
      --   function()
      --     local root_dir = require("utils.root").get()
      ...
      --     if not ok then
      --       vim.notify("Project.nvim is not installed", vim.log.levels.ERROR, {
      --         title = "Fzf Lua",
      --       })
      --       return
      --     end
