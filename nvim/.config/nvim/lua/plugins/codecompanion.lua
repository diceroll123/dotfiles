  ...
  },
  {
    ...
    opts = {
      strategies = {
        chat = {
          adapter = "copilot",
          roles = { llm = "  Copilot Chat", user = "dice" },
          slash_commands = {
            ["buffer"] = {
          ...
          prompts = {
            {
              role = "user",
              content = function()
                return "@cmd_runner Write commit message with commitizen convention. Write clear, informative commit messages that explain the 'what' and 'why' behind changes, not just the 'how'. Keep the commit message separate from the description by using two -m flags. Run the command to commit it."
                  .. "\n\n```\n"
